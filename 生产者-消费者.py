...
class Manager:
    ...
    def __get_item(c_index, b_q):
        sleep(random.random())  # 模拟从缓冲区取出产品的时间
    ...
    def __consume(c_index):
        sleep(random.random() / 1.5)    # 模拟消费产品的时间
